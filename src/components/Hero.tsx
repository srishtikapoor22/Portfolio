  ...
  return (
    <section className="bg-gray-900 text-white min-h-screen flex items-center justify-center relative">
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-6">Aspiring Full-Stack Developer & AI Enthusiast from [Your University]</p>
        <p className="text-lg mb-4">Certifications: [Your Certifications]</p>
        <p className="text-lg mb-6">Hackathons: [Your Hackathons]</p>
        <motion.a
